# V2 UI Bug Task Tracker

Git-native board for cleaning layout, removing unwanted elements, and fixing placement bugs.
...
| UIBUG-14 | Remove legacy/dead components | P1 | TODO |  |  |
...
1. Create one issue per `UIBUG-xx` from `.github/ISSUE_TEMPLATE/ui-bug-task.md`.
2. Paste the issue URL in the `Link` column.
3. Keep task status synced in this file in each PR.
